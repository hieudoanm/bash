...
Bash is a focused project in this monorepo that delivers a practical tool with a clean user experience across platforms.

## ✨ 2. Features

1. [x] Core functionality tailored to Bash
...
- 🌐 [Live Demo](https://hieudoanm.github.io/bash/)

## 🚀 4. Usage

- 🌐 [Web](https://hieudoanm.github.io/bash/)
- 💻 [CLI](https://github.com/hieudoanm/bash/releases)
- 📱 [Mobile](https://github.com/hieudoanm/bash/releases)
- 🖥️ [Desktop](https://github.com/hieudoanm/bash/releases)
  - 🍎 [MacOS](https://github.com/hieudoanm/bash/releases/tag/macos-latest)
  - 🐧 [Ubuntu](https://github.com/hieudoanm/bash/releases/tag/ubuntu-latest)
  - 🪟 [Windows](https://github.com/hieudoanm/bash/releases/tag/windows-latest)
